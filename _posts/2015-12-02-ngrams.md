...
code (section 2). And finally gives a very effective and low memory footprint
method of extracting them (section 3).
...
scrambled in any order and counted. Order does not matter to the model. So how
can we incorporate some structure into it? Taking word bi-grams, where
